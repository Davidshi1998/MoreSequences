...
def run_test_polygon():
    ...
    # Tests 3:
    title = 'POLYGON tests 3: 4 segments (black lines, thickness=5) on a lime green circle '
    window = rg.RoseWindow(400, 400, title)
    circle = rg.Circle(rg.Point(200, 200), 150)
...
def run_test_fancy_polygon():
    ...
    title = 'FANCY POLYGON test 4:20 segments, hops = 5 (blue lines, thickness=5) on a  limegreen-filled  circle .'
    window = rg.RoseWindow(480, 350, title)
    ...
    title = 'FANCY POLYGON test 5:51 segments with hops = 25 (red lines, thickness=1)  on a   white-filled circle'
    window = rg.RoseWindow(480, 350, title)
    circle = rg.Circle(rg.Point(240, 165), 150)
    ...
    title = 'FANCY POLYGON test 5:300 segments with hops= 61 (black lines, thickness=1)  on a   yellow-filled circle '
    window = rg.RoseWindow(480, 350, title)
    circle = rg.Circle(rg.Point(240, 165), 150)
    circle.fill_color = 'yellow'
